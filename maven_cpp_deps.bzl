...
def __setup_bzlmodrio_navx_cpp_dependencies(mctx):
    ...
    maybe(
        ...
        build_file = "@bzlmodrio-navx//private/cpp/Studica-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        ...
        build_file = "@bzlmodrio-navx//private/cpp/Studica-cpp:static.BUILD.bazel",
    )
    maybe(
        http_archive,
    ...
    maybe(
        ...
        build_file = "@bzlmodrio-navx//private/cpp/Studica-driver:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        ...
        build_file = "@bzlmodrio-navx//private/cpp/Studica-driver:static.BUILD.bazel",
    )
    maybe(
        http_archive,
